...
نکات:
- در این پروژه، Vite روی پورت ثابت `8308` اجرا می‌شود (در `vite.config.js` تنظیم شده است).
...
تمام! بک‌اند روی `http://localhost:3855` و فرانت‌اند روی `http://localhost:8308` بالا می‌آید.
